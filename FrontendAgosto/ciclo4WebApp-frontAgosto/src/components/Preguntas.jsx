...
export default function Preguntas() {
    ...
    const obtenerPreguntas = async () => {
        ...
        const respuesta = await Axios.get('pregunta/listar',
            {
    ...
    const buscar = async (e) => {
        ...
        const token = sessionStorage.getItem('token')
        const respuesta = await Axios.get('pregunta/buscarpreguntaenca/' + buscar + '/', {
            headers: {'autorizacion': token}
        })
        setPreguntas(respuesta.data)
    }
    const guardar = async (e) => {
        ...
        const token = sessionStorage.getItem('token')
        const respuesta = await Axios.post('pregunta/crear', pregunta,
            {
                headers: {'autorizacion': token}
            })
    ...
    const ActDes = async (e) => {
        ...
        const respuesta = await Axios.put('pregunta/activar/' + id, {
        // const respuesta = await Axios.put('pregunta/activar/' + id, constEstado, {
            headers: {'autorizacion': token}
        })
        const mensaje = respuesta.data.mensaje
        Swal.fire({
