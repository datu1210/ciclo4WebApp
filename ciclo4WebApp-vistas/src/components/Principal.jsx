...
{/* ---------------------------------------------------Modal Razonamiento cuantitativo--------------------------------------------------------------------------------------- */}
                    <div className="modal fade" id="cuantitativo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="cuantitativoLabel" aria-hidden="true">
                        <div className="modal-dialog modal-lg">
                            <div className="modal-content">
                                <div className="modal-header table-dark" style={{ backgroundColor: "#182434" }}>
                                    <h5 className="modal-title" id="cuantitativoLabel"> {preguntas[index].categoria}</h5>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div className="form-check">
...
{/* ---------------------------------------------------Modal Ingles --------------------------------------------------------------------------------------- */}
<div className="modal fade" id="ingles" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="inglesLabel" aria-hidden="true">
                        <div className="modal-dialog modal-lg">
                            <div className="modal-content">
                                <div className="modal-header table-dark" style={{ backgroundColor: "#182434" }}>
                                    <h5 className="modal-title" id="inglesLabel"> {preguntas[index].categoria}</h5>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div className="form-check">
...
{/* ---------------------------------------------------Modal Lectura Critica --------------------------------------------------------------------------------------- */}
<div className="modal fade" id="critica" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="criticaLabel" aria-hidden="true">
                        <div className="modal-dialog modal-lg">
                            <div className="modal-content">
                                <div className="modal-header table-dark" style={{ backgroundColor: "#182434" }}>
                                    <h5 className="modal-title" id="criticaLabel"> {preguntas[index].categoria}</h5>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div className="form-check">
...
{/* ---------------------------------------------------Modal Competencias Ciudadanas --------------------------------------------------------------------------------------- */}
<div className="modal fade" id="ciudadanas" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="ciudadanasLabel" aria-hidden="true">
                        <div className="modal-dialog modal-lg">
                            <div className="modal-content">
                                <div className="modal-header table-dark" style={{ backgroundColor: "#182434" }}>
                                    <h5 className="modal-title" id="ciudadanasLabel"> {preguntas[index].categoria}</h5>
                                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div className="modal-body">
                                    <div className="form-check">
